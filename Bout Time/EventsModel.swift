...
var arrayOfEvents: [Event] = [Event(event: "Steve Wozniak was born", year: 1950, url: "https://en.wikipedia.org/wiki/Steve_Wozniak"),
                                ...
                                Event(event: "Jobs drops out of Reed College", year: 1972, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Reed_College"),
                                Event(event: "Jobs works for Atari", year: 1974, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Pre-Apple"),
                                ...
                                Event(event: "Apple conduscts an initial public offering of 4.6 million shares at $22 per share", year: 1980, url: "https://en.wikipedia.org/wiki/Apple_Inc.#1976.E2.80.9384:_Founding_and_incorporation"),
                                ...
                                Event(event: "Apple discontinues the Lisa after a disappointing run, and Steve Jobs leaves the company.", year: 1985, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Apple_.281976.E2.80.931985.29"),
                                Event(event: "Apple buys Steve Jobs' company, NeXT Software.", year: 1996, url: "https://en.wikipedia.org/wiki/Steve_Jobs#NeXT_Computer_2"),
                                Event(event: "In the wake of corporate shakeups and a sales slump, Apple welcomes Jobs back as interim CEO.", year: 1997, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Return_to_Apple"),
                                Event(event: "The iMac, a streamlined personal computer, debuts", year: 1998, url: "https://en.wikipedia.org/wiki/Steve_Jobs#iMac"),
                                Event(event: "Jobs becomes permanent CEO.", year: 2000, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Return_to_Apple"),
                                ...
                                Event(event: "The iPhone is unveiled.", year: 2007, url: "https://en.wikipedia.org/wiki/Apple_Inc.#iPhone"),
                                Event(event: "The iPad is announced.", year: 2010, url: "https://en.wikipedia.org/wiki/Apple_Inc.#iPad"),
                                Event(event: "Steve Jobs dies", year: 2011, url: "https://en.wikipedia.org/wiki/Steve_Jobs#Death"),
                                Event(event: "Apple Unveils the Apple Watch", year: 2014, url: "https://en.wikipedia.org/wiki/Apple_Inc.#Apple_Watch"),
                                Event(event: "Apple unveils Apple Music", year: 2015, url: "https://en.wikipedia.org/wiki/Apple_Music"),
                                Event(event: "The European Union rules that Apple must pay Ireland $14.5 billion in back taxes", year: 2016, url: "https://en.wikipedia.org/wiki/Apple_Inc.#Tax_practices"),
                                Event(event: "Apple's market capitalization is $800 billion", year: 2017, url: "https://en.wikipedia.org/wiki/Apple_Inc.#Finance"),
                                ]
